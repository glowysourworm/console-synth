...
AudioEffect* createEffectInstance(float samplingRate) {return new PurestConsoleChannel(samplingRate);}

PurestConsoleChannel::PurestConsoleChannel(float samplingRate) :
