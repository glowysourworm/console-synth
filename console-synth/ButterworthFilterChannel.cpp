...
ButterworthFilterChannel::~ButterworthFilterChannel()
{

}

void ButterworthFilterChannel::Set(float cutoffFrequency, float resonance)
{
...
{
	float output = inputSample * this->outputGain;
	float new_hist;
...
bool ButterworthFilterChannel::HasOutput(float absoluteTime) const
{
	return true;
}
