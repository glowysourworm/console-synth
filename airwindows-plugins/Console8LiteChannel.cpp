...
AudioEffect* createEffectInstance(float samplingRate) {return new Console8LiteChannel(samplingRate);}

Console8LiteChannel::Console8LiteChannel(float samplingRate) :
