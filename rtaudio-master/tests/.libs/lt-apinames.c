...
/* ./.libs/lt-apinames.c - temporary wrapper executable for .libs/apinames
   Generated by libtool (GNU libtool) 2.4.6

   The apinames program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "apinames"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# apinames - temporary wrapper script for .libs/apinames\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The apinames program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"apinames:apinames:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"apinames:apinames:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"apinames:apinames:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
