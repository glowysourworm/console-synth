...
AudioEffect* createEffectInstance(float samplingRate) {return new PurestConsole3Buss(samplingRate);}

PurestConsole3Buss::PurestConsole3Buss(float samplingRate) :
